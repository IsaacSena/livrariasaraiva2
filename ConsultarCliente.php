...
.dropdown-submenu:hover > .dropdown-menu {
    ...
    <div class="container form-container">
        <h1 class="text-center-custom">Consultar Cliente</h1><br>

        <!-- Formulário para consultar cliente -->
        ...
        <!-- Caixa para exibir as informações do cliente -->
        <?php
        if (isset($_POST['idCliente']) && $_POST['idCliente'] != "") {
            $cliente = $consultar->consultarCliente($conexao, $_POST['idCliente']);
            if ($cliente) {
                echo '<div class="consultar-box">';
                echo '<h4>Informações do Cliente</h4>';
                echo '<p><strong>Código:</strong> ' . $cliente['idCliente'] . '</p>';
                echo '<p><strong>Nome:</strong> ' . $cliente['nome'] . '</p>';
                echo '<p><strong>Endereço:</strong> ' . $cliente['endereco'] . '</p>';
                echo '<p><strong>Telefone:</strong> ' . $cliente['telefone'] . '</p>';
                echo '<p><strong>Data de Nascimento:</strong> ' . $cliente['dataNascimento'] . '</p>';
                echo '<p><strong>Login:</strong> ' . $cliente['loginn'] . '</p>';
                echo '<p><strong>Senha:</strong> ' . $cliente['senha'] . '</p>';
                echo '<p><strong>Situação:</strong> ' . $cliente['situacaoCliente'] . '</p>';
                echo '</div>';
            }
        }
        ?>
