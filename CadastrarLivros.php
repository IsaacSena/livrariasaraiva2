...
.dropdown-submenu:hover > .dropdown-menu {
    ...
    <div class="container form-container">
        <h1 class="text-center-custom">Cadastrar Livros</h1><br>
        ...
        <form class="form-control form-control-sm" method="POST">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput2" class="form-label">Preço do livro</label>
                <input type="text" class="form-control" id="exampleFormControlInput2" name="precoLivro" required>
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput3" class="form-label">Quantidade de livros</label>
                <input type="text" class="form-control" id="exampleFormControlInput3" name="quantidadeLivros" required>
            </div> 
        ...
        if (isset($_POST['titulo']) && $_POST['titulo'] != "" && isset($_POST['precoLivro']) && $_POST['precoLivro'] != "" && isset($_POST['quantidadeLivros']) && $_POST['quantidadeLivros'] != "") {
            try {
                ...
                $situacaoLivro = "Ativo"; // Definindo a situação do livro como "Ativo" por padrão

                $inserir->cadastrarLivro($conexao, $titulo, $precoLivro, $quantidadeLivros, $situacaoLivro);
                echo "<br><br><div class='alert alert-success'>Livro cadastrado com sucesso!</div>";
            } catch (Exception $erro) {
                echo "<br><br><div class='alert alert-danger'>Algo deu errado! Erro: $erro</div>";
            }
        }
        ?>
    </div>
