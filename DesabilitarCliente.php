...
<head>
    ...
    <title>Desabilitar Cliente</title>
...
.dropdown-submenu:hover > .dropdown-menu {
    ...
    <!-- Tela Desabilitar Cliente -->
    <div class="container form-container">
        <h1 class="text-center-custom">Desabilitar Cliente</h1><br>

        <!-- Formulário para desabilitar cliente -->
        <form class="form-control form-control-sm" method="POST">
            ...
            <div class="mb-3">
                <select name="campos" class="form-select" aria-label="Escolha o campo para desabilitar">
                    <option selected>Escolha o campo para desabilitar</option>
                    <option value="situacaoCliente">Situação do Cliente</option>
                </select>
            </div>

            <div class="mb-3">
                <select id="novoDado" name="novoDado" class="form-select" aria-label="Escolha o status do cliente">
