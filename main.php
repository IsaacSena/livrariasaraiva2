        ...
        <aside class="col-md-3">
            <div class="Main p-3 shadow-sm rounded border">
                ...
                <div class="mb-3 d-flex align-items-center border-bottom pb-2">
                    <a href="Livros.php"><img src="https://m.media-amazon.com/images/I/81h4CdNxdgL._SY385_.jpg" width="50" height="75" class="me-2"></a>
                    <div>
                ...
                <div class="mb-3 d-flex align-items-center border-bottom pb-2">
                    <a href="Livros.php"><img src="https://m.media-amazon.com/images/I/51vXa1V2pbL._AC_UY218_.jpg" width="50" height="75" class="me-2"></a>
                    <div>
                ...
                <div class="d-flex align-items-center">
                    <a href="Livros.php"><img src="https://m.media-amazon.com/images/I/91jny5rWgES._AC_UY218_.jpg" width="50" height="75" class="me-2"></a>
                    <div>
    ...
    <div class="p-3 shadow-sm rounded border">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center mb-3">
                ...
                <div class="mt-2" name = "metamorfose">
        ...
        <div class="d-flex justify-content-center mt-4">
            <a href="Livros.php" class="btn btn-outline-warning" role="button">Mais Livros</a>
        </div>
</section>
    </div>
</div>
...
<div style="width: 1558px; height: 392px; position: relative; border-radius: 20px; background-color: white; border: 1px solid black;">
  <!-- Imagem ajustada para ocupar todo o espaço do contêiner -->
  ...
  <!-- Caixa de texto para o novo input -->
