...
.dropdown-submenu:hover > .dropdown-menu {
    ...
    <div class="container form-container">
        <h1 class="text-center-custom">Atualizar Livro</h1><br>
        ...
        <form class="form-control form-control-sm" method="POST">
            ...
            <div class="mb-3">
                <label for="exampleFormControlSelect1" class="form-label">Escolha um campo para atualizar</label>
                <select name="campos" class="form-select" aria-label="Default select example" required>
        ...
        if (isset($_POST['idLivros']) && $_POST['idLivros'] != "" && isset($_POST['campos']) && $_POST['campos'] != "" && isset($_POST['novoDado']) && $_POST['novoDado'] != "") {
            try {
                ...
                $atualizar->atualizarLivro($conexao, $campo, $novoDado, $idLivros);
                echo "<br><br><div class='alert alert-success'>Livro atualizado com sucesso!</div>";
